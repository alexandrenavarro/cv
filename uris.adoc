...
// Paulo Jerônimo/CV
:uri-cv: {uri-paulojeronimo}/cv/en
...
:uri-paulojeronimo-facebook: https://www.facebook.com/paulojeronimo74
:uri-paulojeronimo-instagram: https://www.instagram.com/paulojeronimo74
:uri-paulojeronimo-youtube: https://www.youtube.com/user/paulojeronimo74
...
:uri-archlinux: https://www.archlinux.org/
...
:uri-haskell: https://www.haskell.org/
:uri-dhall: https://dhall-lang.org/
:uri-rust: https://www.rust-lang.org/
...
:uri-jinja: https://jinja.palletsprojects.com/en/2.11.x/
...
:uri-blockchain: https://blockchain4devs.github.io/blockchain-demo/docs/pt-br/
:uri-ethereum: https://ethereum.org/en/learn/#ethereum-basics
:uri-solidity: https://solidity.readthedocs.io/en/develop/
:uri-vyper: https://vyper.readthedocs.io/en/stable/
:uri-groovy: http://groovy-lang.org/
:uri-puppeteer: https://pptr.dev/

// Java Frameworks
:uri-java-ee: http://www.oracle.com/technetwork/java/javaee/overview/index.html
:uri-hibernate: https://hibernate.org/
:uri-spring: https://spring.io/
:uri-spring-boot: https://spring.io/projects/spring-boot
:uri-spring-cloud-dataflow: https://spring.io/projects/spring-cloud-dataflow
...
:uri-npm: https://www.npmjs.com/
:uri-yarn: https://yarnpkg.com/
:uri-angularjs: https://angularjs.org/
:uri-angular: https://angular.io/
:uri-react: https://reactjs.org/
:uri-nextjs: https://nextjs.org/
:uri-react-native: https://reactnative.dev/
:uri-jest: https://jestjs.io/
:uri-mocha: https://mochajs.org/
:uri-chai: https://www.chaijs.com/

:uri-cucumber: https://cucumber.io/
:uri-spock: http://spockframework.org/
:uri-spek: https://www.spekframework.org/

// Tools/Version Control
:uri-git: https://git-scm.org
:uri-subversion: https://subversion.apache.org/
// Tools/Editors
...
:uri-visualstudiocode: https://code.visualstudio.com/
...
:uri-sonarqube: https://www.sonarqube.org/
...
:uri-cloudfoundry-uaa: https://docs.cloudfoundry.org/uaa/
...
:uri-mongodb: https://www.mongodb.com/
...
:uri-caixa-seguradora: https://caixaseguradora.com.br
...
:uri-delphi: https://www.embarcadero.com/products/delphi
:uri-vmware: https://www.vmware.com/
:uri-gcp: https://cloud.google.com/
:uri-sed: https://www.gnu.org/software/sed/
:uri-awk: https://www.gnu.org/software/gawk/
:uri-curl: https://curl.se/
:uri-httpie: https://httpie.io/
:uri-jq: https://stedolan.github.io/jq/
:uri-postman: https://www.postman.com/
:uri-agile: https://en.wikipedia.org/wiki/Agile_software_development
:uri-extreme-programming: https://en.wikipedia.org/wiki/Extreme_programming
:uri-continuous-integration: https://en.wikipedia.org/wiki/Continuous_integration
:uri-kanban: https://en.wikipedia.org/wiki/Kanban_(development)
:uri-scrum: https://en.wikipedia.org/wiki/Scrum_(software_development)
:uri-tdd: https://en.wikipedia.org/wiki/Test-driven_development
:uri-bdd: https://en.wikipedia.org/wiki/Behavior-driven_development
:uri-integration-testing: https://en.wikipedia.org/wiki/Integration_testing
:uri-acceptance-testing: https://en.wikipedia.org/wiki/Acceptance_testing
:uri-xml: https://www.w3schools.com/xml/
:uri-xslt: https://www.w3schools.com/xml/xsl_intro.asp
:uri-html: https://www.w3schools.com/html/
:uri-css: https://www.w3schools.com/css/
:uri-sass: https://sass-lang.com/
:uri-styled-components: https://styled-components.com/
:uri-json: https://www.json.org/
:uri-yaml: https://yaml.org/
:uri-dhall: https://dhall-lang.org/
:uri-elk-stack: https://www.elastic.co/what-is/elk-stack
:uri-rabbitmq: https://www.rabbitmq.com/
:uri-kafka: https://kafka.apache.org/t
:uri-swagger: https://swagger.io/
:uri-websocket: https://en.wikipedia.org/wiki/WebSocket
:uri-oauth: https://en.wikipedia.org/wiki/OAuth
:uri-oidc: https://en.wikipedia.org/wiki/OpenID_Connect
:uri-spring-security: https://spring.io/projects/spring-security
:uri-openssl: https://www.openssl.org/
:uri-gnupg: https://gnupg.org/
:uri-passbolt: https://www.passbolt.com/
:uri-uml: https://en.wikipedia.org/wiki/Unified_Modeling_Language
:uri-scala: https://www.scala-lang.org/
